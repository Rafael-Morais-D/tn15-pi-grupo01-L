...
<section class="container my-3">
    <form action="{{route('pedido.concluido')}}" method="post" class="row">
        ...
        <article class="col-12 col-md-7" id="formularioPagamento">
            <div class="">
                <h2 class="col-12 text-center py-4">Pagamento/h2>
                <div class="col-md-12">
                ...
                <div id="enderecoEntrega" class="collapse col-md-12">
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-6">
                            <label for="emailDestinatario">Email</label>
                    ...
                    <div class="form-group">
                        <label for="observacaoEntrega">Observção</label>
                    ...
                    <ul class="dadosPedido">
                        @foreach ($pedidos as $pedido)
                            ...
                            <li class="row">
                                ...
                                <div class="col-9 d-flex align-items-center">
                                    <p class="mb-0 flex-grow-1">Envio</p>
                                </div>
                                <div class="col-3 text-right d-flex align-items-center">
                            ...
                            <li>
                                <small class="text-muted mt-0">Prazo de Entrega: até 6h após o pedido</small>
                            </li>
